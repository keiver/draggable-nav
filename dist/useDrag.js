...
// Parameter clamping
// ---------------------------------------------------------------------------
function safeClamp(value, fallback, min) {
...
function snapToVerticalEdge(nav, newMode, newEdge, setMode, setEdge, setIsDragging, offsetRef) {
    withViewTransition(() => {
        nav.style.transform = "";
        flushSync(() => {
            setMode(newMode);
...
function snapToHorizontalCenter(nav, setMode, setEdge, setIsDragging, offsetRef) {
    withViewTransition(() => {
        nav.style.transform = "";
        flushSync(() => {
            setMode("horizontal");
